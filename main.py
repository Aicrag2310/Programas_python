...
with open('CSV/beauty.csv', 'r') as archivo_csv, open('sentencias.sql', 'w') as archivo_sql:
    ...
    for fila in lector_csv:
        ...
        sentencia = "INSERT INTO "+ name_table+" (`id`, `brandId`, `name`,`model`,`baseCost`,`measuringUnitId`,`isActive`,`isKit`) VALUES ({}, {},"{}" , {}, {}, {}, {});\n".format(
            fila['id'], fila['brandId'],name,fila['model'],fila['uploadRetailPrice'],fila['measuringUnitId'],fila['isActive'],fila['isKit'])
